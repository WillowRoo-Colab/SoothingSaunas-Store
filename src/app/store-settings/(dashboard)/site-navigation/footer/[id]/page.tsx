...
export default async function EditFooterNavItemPage({
  params,
}: {
  ...
  return (
    <div className="max-w-lg">
      <h2 className="font-display text-lg text-charcoal">Edit footer nav item</h2>

      <form action={boundUpdate} className="mt-6">
        <NavItemFormFields location="footer" navItem={item} />
        <button
          type="submit"
